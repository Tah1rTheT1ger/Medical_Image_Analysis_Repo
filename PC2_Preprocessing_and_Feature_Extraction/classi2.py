...
def extract_combined_features(image_path):
    ...
    try:
        ...
        # Calculate properties, averaging over the 4 angles
        ...
        # --- 3. Combine Features ---
        combined_features = np.hstack((lbp_hist, glcm_features))
...
def compile_dataset_features(base_data_dir):
    """
    Compiles COMBINED LBP and GLCM features from the NPancreas and PPancreas subdirectories.
    """
    feature_list = []
    label_list = []
    ...
    for class_name, label in class_map.items():
        ...
        for file_path in image_files:
            # Use the new combined feature extraction function
...
if __name__ == '__main__':
    ...
    # 2. Extract Features (Now combined LBP + GLCM)
    ...
    if X_raw.size == 0:
        ...
        print(f"Features Used: Combined LBP + GLCM (6 properties)")
